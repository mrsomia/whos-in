...
export default function NewEventsFrom() {
  return (
    <>
      <Form.Root className="my-4 flex w-4/5 flex-col items-center justify-between space-y-4">
        <Form.Field className="flex w-full flex-col space-y-1" name="eventName">
        ...
        <Form.Field className="flex w-full flex-col space-y-1" name="date">
          <div className="flex items-baseline justify-between">
              ...
              <Select.Portal>
                ...
                >
                  <Select.Viewport className="p-2">
                    ...
                    <Select.Item value="Every 2 Weeks" className="p-1 py-2">
        ...
        <Form.Field className="flex w-full flex-col space-y-1" name="location">
          <div className="flex items-baseline justify-between">
